...
const InputBox = memo(function ({
    ...
    function showPassword() {
        ...
        if (inputRef.current?.value === "") alert("Please type your Password")
        if (currentVal === "text")
    ...
    return (
        <div className="flex-col justify-center my-3">
            ...
            <div className="relative w-72">
                ...
                {type === "password" && <div onClick={showPassword} className="absolute top-1/2 right-2 -translate-y-1/2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 cursor-pointer hover:rounded-full hover:bg-slate-200">
